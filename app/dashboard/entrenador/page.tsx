...
import { Users, Calendar, DollarSign, Settings, LogOut, Home } from 'lucide-react'
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <h2 className="text-xl font-bold text-neutral-900 mb-2">Ingresos</h2>
            <p className="text-neutral-600 mb-4">
              Revisa tus ganancias y pagos
            </p>
            <button className="w-full px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold rounded-xl transition-colors">
              Ver Ingresos
            </button>
          </div>
