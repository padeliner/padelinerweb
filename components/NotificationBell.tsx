...
export default function NotificationBell() {
  ...
  return (
    <div className="relative">
      ...
      >
        <Bell className="w-5 h-5 sm:w-6 sm:h-6 text-neutral-700" />
        {unreadCount > 0 && (
          <span className="absolute bottom-0 right-0 w-5 h-5 bg-red-500 text-white text-xs font-bold rounded-full flex items-center justify-center">
